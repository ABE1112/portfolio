...
const HeaderWrapper = styled.div`
  ...
  z-index: 999;
  color: ${Colors.darker};
  background: ${props => (props.scrolled ? `${Colors.darker};` : 'transparent')};
  ...
  ${Button} {
    ...
    &:hover {
      color: ${props => props.scrolled && `${lighten(0.3, Colors.white)}`};
      border: 1px solid ${props => props.scrolled && `${lighten(0.3, Colors.white)}`};
    }
    ${media.menuMax`
      padding: 15px 20px;
    `}
