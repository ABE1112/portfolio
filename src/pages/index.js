        ...
        <Layout theme="white" bigFooter openContactPopup={this.openContactPopup}>
          ...
          <Block>
            <BlockContent>
              ...
              <DivWrapper>
                <t.H2 bold>Drupal 8 + Bootstrap 3 website</t.H2>
                <t.P>Lorem ipsum</t.P>
          ...
          <Block>
            <BlockContent>
              <DivWrapper>
                <t.H2 bold>Symfony 4 Website</t.H2>
                <t.P>Lorem ipsum</t.P>
                <t.P>Dolor sit amet</t.P>
                <LinkButton primary bold className="link" as="a"
                  target="_blank"
              ...
              <DivWrapper>
                <ItemImage src={Placeholder1} alt="Placeholder title" />
              </DivWrapper>
            </BlockContent>
          </Block>
          <Block>
            <BlockContent>
              <DivWrapper>
                <ItemImage src={Placeholder3} alt="Placeholder title" />
              </DivWrapper>
              <DivWrapper>
                <t.H2 bold>Laravel Website</t.H2>
                <t.P>Lorem ipsum</t.P>
                <t.P>Dolor sit amet</t.P>
                <LinkButton primary bold className="link" as="a"
                  target="_blank"
          ...
          <Block>
            <BlockContent>
              <DivWrapper>
                <t.H2 bold>Wordpress + React Website</t.H2>
                <t.P>Lorem ipsum</t.P>
                <t.P>Dolor sit amet</t.P>
                <LinkButton primary bold className="link" as="a"
                  target="_blank"
              ...
              <DivWrapper>
                <ItemImage src={Placeholder2} alt="Placeholder title" />
              </DivWrapper>
            </BlockContent>
          </Block>
          <WorkWithMe>
